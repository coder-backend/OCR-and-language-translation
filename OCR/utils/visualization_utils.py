...
This functions do not return a value, instead they modify the image itself.
"""
import collections
import functools
import numpy as np
...
from Image_to_Text.core import standard_fields as fields

current_obj_isSerial=False;
...
def draw_bounding_box_on_image(image,
  ...
  for display_str in display_str_list[::-1]:
    ...
    if "serialreadable" not in display_str_list[::-1] :
        
        current_obj_isSerial=False
    else :  print(display_str)
       # current_obj_isSerial=True
...
def return_coordinates(
  ...
  for box, color in box_to_color_map.items():
    ...
    if(coordinates_list[0]==0):
        if(last_box_coords[0]==0):
            last_box_coords=[100, 100, 100, 100, (50)]
            print("failed")
        return last_box_coords
    else:
